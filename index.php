					...
					<div class="col-md-6">
						...
						<div class="card card-outline-secondary">
							<div class="card-header">
								<h3 class="mb-0">SIMPLE QR CODE GENERATOR</h3>
							</div>
							<?php
							$first_name = "Khaleeq";
							$last_name = "Zaman";
							$email = "web.engineer@hotmail.com";
							$company = "Cyber Sleek";
							$website = "http://www.cybersleek.com";
							...
							<div class="card-body">
								...
								<?php
									...
									echo '<center><img src="' . $PNG_TEMP_DIR . basename($filename) . '" /></center><hr/>';
								}
